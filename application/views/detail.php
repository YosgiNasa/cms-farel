		...
		<div class="container-xxl position-relative p-0">
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					...
					<a href="<?= base_url('auth') ?>" class="btn btn-primary py-2 px-4">login</a>
				</div>
			</nav>
							...
							<center>
								...
								<div class="carousel-item <?php if($no==1){ echo 'active' ;} ?>">
									<img src="<?= base_url('assets/upload/caraousel/'.$aa['foto']) ?>"
										style="margin-left: width: 25%; height: 25%; border-radius:50%; ;"
										class=" d-block w-50">
								</div>
								<?php $no++; } ?>
							</center>
				...
				<div class="row g-5">
					...
					<div class="col-lg-3 col-md-6">
						...
						<div class="d-flex pt-2">
							...
							<a class="btn btn-outline-light btn-social" href="<?= $konfig->facebook; ?>"><i
									class="fab fa-facebook-f"></i></a>
							<a class="btn btn-outline-light btn-social" href="<?= $konfig->instagram; ?>"><i
									class="fab fa-instagram-f"></i></a>
